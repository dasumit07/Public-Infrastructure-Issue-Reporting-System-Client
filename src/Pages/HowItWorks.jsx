      ...
      <div className='bg-gray-50'>
         ...
         <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-5 md:px-20">
            ...
            <div className="p-6 bg-white shadow-md rounded-xl text-center hover:shadow-lg hover:scale-105 transition ease-in-out">
               ...
               <div className="text-teal-600 text-5xl mb-4 flex items-center justify-center"><GrUserAdmin /></div>
            ...
            <div className="p-6 bg-white shadow-md rounded-xl text-center hover:shadow-lg hover:scale-105 transition ease-in-out">
               ...
               <div className="text-teal-600 text-5xl mb-4 flex items-center justify-center"><MdOutlinePendingActions /></div>
            ...
            <div className="p-6 bg-white shadow-md rounded-xl text-center hover:shadow-lg hover:scale-105 transition ease-in-out">
               ...
               <div className="text-teal-600 text-5xl mb-4 flex items-center justify-center"><IoIosCloudDone /></div>
