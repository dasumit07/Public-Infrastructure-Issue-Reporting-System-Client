    ...
    return (
        <div className='bg-gray-50 mb-5'>
                ...
                <div className="p-6 bg-white shadow-md rounded-xl text-center hover:shadow-lg transition hover:scale-105 ease-in-out">
                    <div class=" text-5xl mb-4 flex items-center justify-center"><SiBoosty /></div>
                ...
                <div className="p-6 bg-white shadow-md rounded-xl text-center hover:shadow-lg hover:scale-105 transition ease-in-out">
                   <div class=" text-5xl mb-4 flex items-center justify-center"><CiMobile3 /></div>
                ...
                <div className="p-6 bg-white shadow-md rounded-xl text-center hover:shadow-lg hover:scale-105 transition ease-in-out">
                   <div class=" text-5xl mb-4 flex items-center justify-center"><LuScanEye /></div>
                ...
                <div className="p-6 bg-white shadow-md rounded-xl text-center hover:shadow-lg hover:scale-105 transition ease-in-out">
                   <div class=" text-5xl mb-4 flex items-center justify-center"><LuHandshake /></div>
